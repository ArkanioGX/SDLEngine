...
void Scene03TriangleVertexBuffer::Load(Renderer &renderer)
{
    ...
    transferData[1] = PositionColorVertex{0.5, -0.5, 0, 255, 255, 0, 255};
    transferData[2] = PositionColorVertex{-0.5, 0.5, 0, 255, 0, 255, 255};
    transferData[3] = PositionColorVertex{0.5, 0.5, 0, 255, 255, 255, 255};
    transferData[4] = PositionColorVertex{0.5, -0.5, 0, 255, 255, 0, 255};
...
void Scene03TriangleVertexBuffer::Draw(Renderer &renderer)
{
    ...
    renderer.DrawPrimitives(6, 2, 0, 0);
    renderer.End();
}
