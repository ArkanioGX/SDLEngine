...
void Scene05TriangleIndexed::Load(Renderer &renderer)
{
...
void Scene05TriangleIndexed::Draw(Renderer &renderer)
{
    renderer.Begin();
...
void Scene05TriangleIndexed::Unload(Renderer &renderer)
{
